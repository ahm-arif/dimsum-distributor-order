...
<html xmlns="http://www.w3.org/1999/xhtml"> <!-- Bagian halaman HTML yang akan konvert -->
    ...
    <body>
        <div id="title">
        Distributor Dimsum Salmon Jakarta
        </div>

        <div id="title-alamat">
            Alamat: Jalan Sementara, Cilandak, Kota Jakarta Selatan, Daerah Khusus Ibukota Jakarta 12450 
        </div>
        
        <!--<div style="margin:0px 0 0 200px">
        ...
        <div id="isi">
            <table width="100%" border="0.5" cellpadding="0" cellspacing="0">
                <tr class="tr-title">
                <th height="20" align="center" valign="middle">Nomor</th>
                ...
                ?>  
                <tr>
                    <td width="5%" height="13" align="center" valign="middle"><?=$i?></td>
                    <td width="20%" height="13" align="center" valign="middle"><?=$no_pengiriman?></td>
                    ...
                    <td style="padding-left:5px;" width="35%" height="13" valign="middle"><?=$nama_barang?></td>
                    <td style="padding-right:5px;" width="20%" height="13" align="center" valign="middle"><?=$jumlah_barang?></td>
                    <!--<td style="padding-right:5px;" width="50" height="13" align="right" valign="middle"> $berat_barang Kg</td>-->
                    <td style="padding-right:5px;" width="20%" height="13" align="right" valign="middle">Rp. <?=$biaya_kirim?></td>
            ...
            <div id="footer-tanggal">
                Jakarta, <?php echo tgl_eng_to_ind("$hari_ini"); ?> <br><br><br><br><br>
                Distributor Dimsum Salmon Jakarta
            </div>
        </div>
    </body>
...
<?php
$filename="Faktur.pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
//==========================================================================================================
